...
export const MOCK_TEAM: TeamMember[] = [
    ...
    { id: 'ai-agent', name: 'AI Agent', role: 'System', facility: 'Munich Plant', avatarInitials: '🤖', avatarColor: '#A855F7', status: 'available', isAI: true },
]
...
const MOCK_REPOS: WorkflowRepo[] = [
    { id: 'repo-1', factoryId: 'factory-munich', name: 'KUKA Axis Vibration Protocol', description: 'Standard procedure for detecting and resolving axis vibration anomalies in robotic arms', stars: 5, forks: 3, isPublic: true, tags: ['robotics', 'predictive', 'SOP-R-012'], language: 'Robotics', lastUpdated: '2026-02-12T10:30:00Z', createdAt: '2025-11-15T08:00:00Z' },
...
const MOCK_FEED: OpshubPost[] = [
    {
        ...
        title: 'Critical Alert: Vibration Pattern Detected on KUKA KR120',
        content: `**KUKA KR120 (Line 4)** shows vibration signature **98% similar** to known gearbox failure pattern.\n\n**Severity:** Critical\n**Recommended Action:** Inspect Axis 4 gearbox immediately.\n**Pattern Source:** Historical failure data (Jan 2025, Detroit Plant).`,
        anomalyRef: 'anomaly-kuka-1',
        workflowRepoRef: 'repo-1',
        tags: ['predictive', 'robotics', 'critical', 'vibration'],
        upvotes: 42,
        comments: 5,
    ...
    },
    {
        ...
        title: 'Cross-Facility Insight: Pattern Match',
        content: `The vibration pattern on **Munich KUKA KR120** matches a resolved issue from **Detroit (2025)**.\n\n**Solution applied in Detroit:** Replaced Axis 4 cycloidal gearbox. \n**Outcome:** Prevented 48h downtime.\n\n**Suggestion:** Create Work Order for gearbox replacement.`,
        tags: ['cross-facility', 'pattern-match', 'robotics'],
        upvotes: 89,
        comments: 12,
        createdAt: '2026-02-13T08:35:00Z',
        status: 'resolved',
        sourceFacilityId: 'factory-detroit',
        targetFacilityId: 'factory-munich',
    },
    {
        id: 'post-3',
        type: 'question',
    ...
    },
    {
        ...
        content: `Investigation complete on Paint Booth #7 humidity issue. **Root cause:** Sensor HS-7A showing intermittent fault — response time degraded from 2s to 12s.\n\nHVAC ducting is clear, no mechanical issues. Recommending sensor replacement with spare HS-VAISALA-HMT120.\n\n@Sarah Chen - approval needed for parts requisition.`,
...
const MOCK_ANOMALIES: DetectedAnomaly[] = [
    ...
    },
    {
        ...
        factoryId: 'factory-munich',
        factoryName: 'Munich Plant',
        equipmentId: 'eq-kuka-kr120',
        equipmentName: 'KUKA KR120 - Assembly Cell 4',
        equipmentType: 'Robotics',
        severity: 'critical',
        description: 'High-frequency vibration detected on Axis 4. RMS 13.5 mm/s (Threshold: 7.0). Pattern matches gearbox wear signature.',
        detectedAt: '2026-02-13T08:15:00Z',
        suggestedWorkflowId: 'repo-1',
        suggestedWorkflowName: 'KUKA Axis Vibration Protocol',
        suggestedAction: 'Inspect and replace Axis 4 gearbox',
        status: 'pending',
        confidence: 0.98,
        remainingUsefulLife: '24 hours',
        estimatedCostIfIgnored: 45000,
        digitalTwinAssetId: 'kuka-kr120-right',
    },
    {
        id: 'anomaly-4',
...
const MOCK_CHANGELOG: ChangelogEntry[] = [
    { id: 'cl-new-1', date: '2026-02-13T09:00:00Z', title: 'Global: KUKA Vibration Protocol now available', description: 'Munich\'s proven KUKA Axis 4 gearbox protection workflow is now available for all sites. Estimated savings: $45k/asset.', factoryId: 'factory-munich', workflowRepoId: 'repo-1', type: 'release' },
    { id: 'cl-1', date: '2026-02-09T14:00:00Z', title: 'Tokyo: Energy forecast model v2.3 — 15% accuracy improvement', description: 'New weather integration reduced prediction error, saving EUR 3,200/week in energy costs', factoryId: 'factory-tokyo', workflowRepoId: 'repo-9', type: 'release' },
    ...
    { id: 'cl-7', date: '2026-02-03T11:00:00Z', title: 'Sao Paulo: Humidity control published — available for adoption', description: 'Reduced product moisture defects 67% in sensitive manufacturing', factoryId: 'factory-saopaulo', workflowRepoId: 'repo-12', type: 'release' },
...
// ─── Execution Checklist Steps (Paint Booth #7 repair) ──────────
...
// ─── KUKA Checklist Steps ──────────────────────────────────────
const MOCK_KUKA_CHECKLIST: ChecklistStep[] = [
    {
        id: 'step-k1',
        order: 1,
        title: 'Safety Lockout / Tagout',
        instructions: 'Engage E-Stop. Lock out main power to Cell 4. Verify zero energy state.',
        caution: 'Ensure robot is in transport position before power down.',
        requiresPhoto: true,
        requiresSignoff: true,
        estimatedTime: '10 min',
        completed: true,
    },
    {
        id: 'step-k2',
        order: 2,
        title: 'Axis 4 Oil Analysis',
        instructions: 'Drain sample of Axis 4 gearbox oil. Check for metal particles/debris.',
        requiresPhoto: true,
        requiresSignoff: false,
        estimatedTime: '15 min',
        completed: false,
    },
    {
        ...
        instructions: 'Remove Axis 4 servo motor. Unbolt gearbox housing. Install replacement unit (Part #KUKA-GB-A4). Torque bolts to 45Nm.',
        requiresPhoto: true,
        requiresSignoff: true,
    ...
    },
    {
        id: 'step-k4',
        order: 4,
        title: 'Calibration & Test Run',
        instructions: 'Perform zero-calibration on Axis 4. Run test program "TEST_AXIS_4_VIB". Verify RMS < 2.0 mm/s.',
        requiresPhoto: true,
        requiresSignoff: true,
...
// ─── Tasks for KUKA WO ──────────────────────────────────────────
const MOCK_TASKS_KUKA: WorkOrderTask[] = [
    {
        id: 'task-kuka-1',
        number: 1,
        workOrderId: 'wo-kuka-01',
        type: 'investigation',
        title: 'Verify Vibration Signature', // Scene 2: Khalid''s task
        description: 'Review 3D timeline and confirm vibration spike correlates with motion cycle.',
        assignee: MOCK_TEAM[1], // Khalid
        assignedBy: MOCK_TEAM[0], // Sara
        priority: 'high',
        status: 'completed',
        dependsOn: [],
        isBlocked: false,
        updates: [
            {
                id: 'update-k1',
                author: MOCK_TEAM[1], // Khalid
                content: 'Confirmed. Spike occurs exactly at Axis 4 reversal point. Definite mechanical play.',
    ...
    },
    {
        ...
        workOrderId: 'wo-kuka-01',
        type: 'execution',
        title: 'Replace Axis 4 Gearbox', // Scene 3: Ahmad''s task
        description: 'Perform gearbox replacement per SOP-R-012.',
        assignee: MOCK_TEAM[2], // Ahmad
        assignedBy: MOCK_TEAM[1], // Khalid
        priority: 'critical',
        status: 'in-progress',
        dependsOn: ['task-kuka-1'],
        isBlocked: false,
        checklist: MOCK_KUKA_CHECKLIST,
        updates: [],
...
const MOCK_TASKS_0847: WorkOrderTask[] = [
    {
        ...
        updates: [
            ...
            },
            {
                id: 'update-1b',
                author: MOCK_TEAM[1],
                content: 'Root cause identified: Sensor HS-7A showing intermittent fault — response time degraded from 2s to 12s. HVAC ducting clear. Recommending sensor replacement.',
...
const MOCK_WORK_ORDER_KUKA: WorkOrderCard = {
    id: 'wo-kuka-01',
    number: 'WO-2026-0912',
    title: 'KUKA Axis 4 Gearbox Inspection',
    description: 'Vibration anomaly detected on Axis 4. AI confidence 98% for gearbox wear signature. Immediate inspection required.',
    equipmentId: 'eq-kuka-kr120',
    equipmentName: 'KUKA KR120 - Assembly Cell 4',
    status: 'in-progress',
    priority: 'critical',
    createdAt: '2026-02-13T08:45:00Z',
    owner: MOCK_TEAM[1], // Khalid
    team: [MOCK_TEAM[1], MOCK_TEAM[2]], // Khalid & Ahmad
    tags: ['robotics', 'vibration', 'critical', 'kuka'],
    linkedAnomalyId: 'anomaly-kuka-1',
    tasks: MOCK_TASKS_KUKA,
    facility: 'Munich Plant',
}
...
// ─── Mock Activity Entries (full timeline for WO-0847) ──────────
...
const MOCK_DISCUSSION: DiscussionComment[] = [
    ...
    },
    {
        ...
        workOrderId: 'wo-0847',
        author: MOCK_TEAM[1],
        content: 'On it. Initial look at the data — the humidity spikes are correlating with HVAC transition cycles. This might be a sensor response time issue rather than actual humidity swings. Pulling detailed logs now.',
        mentions: [],
        createdAt: '2026-02-09T10:30:00Z',
    },
    {
    ...
    workflow: {
        ...
        generatedFrom: {
            ...
            correlations: [
                ...
                'Sensor degradation follows exponential curve — detectable 48-72h before critical failure',
            ],
        },
    },
    sop: {
        ...
        steps: [
            ...
            { order: 3, title: 'Test Sensor Response Time', instructions: 'Use calibrated humidity generator to step-test sensor response. Measure T90 response time. Spec: < 5 seconds.', requiresPhoto: false, requiresSignoff: false, estimatedTime: '15 min', sourceNote: 'New step — derived from root cause analysis' },
