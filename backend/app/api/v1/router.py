...
api_router.include_router(agent_router, tags=["agent"])   # prefix already set in router
...
api_router.include_router(dispatcher_router, tags=["dispatcher"])    # prefix set in router
api_router.include_router(integrations_router, tags=["integrations"])  # prefix set in router
